...
//		customer=Customer(name=홍동현, email=shift, 
//		address=Customer.Address(street=전포대로, city=부산, postalCode=12345)), 
//		products=[Product(name=삼성 북 4, price=1200.1, description=삼성 북 시리즈의 네 번째 모델), 
