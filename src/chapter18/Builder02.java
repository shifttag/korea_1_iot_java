...
//		Student st1 = new Student("홍동현", 25, "1학년");
...
//		System.out.println(st3.getName());	// 김명진
		...
		Student std1 = new Student.Builder("홍동현", 25).build();
		Student std2 = new Student.Builder("홍길동", 30)
				.grade("1학년")
				.major("회계학과")
				.build();
		Student std3 = new Student.Builder("김명진", 34)
				.grade("3학년")
				.build();
		Student std4 = new Student.Builder("이도희", 19)
				.major("심리학과")
				.build();
		
		
		System.out.println(std1.getName());	// 홍동현
		System.out.println(std2.getName());	// 홍길동
		System.out.println(std3.getName());	// 김명진
		System.out.println(std4.getName());	// 이도희
	}
}
