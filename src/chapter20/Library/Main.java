...
public class Main {
	public static void main(String[] args) {
		...
		bookController.addBook("자바 한 번에 끝내기", "이승수", 2023);
		bookController.addBook("자바스크립트 한 번에 끝내기", "제정빈", 2020);
		bookController.addBook("리액트 한 번에 끝내기", "정영훈", 2021);
		bookController.addBook("SQL 한 번에 끝내기", "류용재", 2024);
		...
		bookController.updateBook(2, "스프링 한 번에 끝내기", "홍동현", 2020);
		...
		bookController.addBook("안녕하세요", "이종민", 2022);
		bookController.getAllBooks().forEach(System.out::println);
	}
}
